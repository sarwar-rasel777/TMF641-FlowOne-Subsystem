...
@Service("serviceOrderCancelled")
public class ServiceOrderCancelled extends ServiceOrderCancelCreateEventService {

  @Autowired
  public ServiceOrderCancelled(EventCreateCancelEventTranslator eventTranslator, ValuesBuilderFactory valuesBuilderFactory, ObjectSerializer objectSerializer, ObjectMapper objectMapper, ObjectValidator objectValidator,
  ...
  public ServiceOrderStateType supportedState() {
    return ServiceOrderStateType.CANCELLED;
  }
