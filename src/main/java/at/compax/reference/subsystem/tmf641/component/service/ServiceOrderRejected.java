...
@Service("serviceOrderRejected")
public class ServiceOrderRejected extends ServiceOrderCreateEventService {

  @Autowired
  public ServiceOrderRejected(EventCreateEventTranslator eventTranslator, ValuesBuilderFactory valuesBuilderFactory, ObjectSerializer objectSerializer, ObjectMapper objectMapper, ObjectValidator objectValidator, @Lazy ReceivingSender receivingSender) {
  ...
  public ServiceOrderStateType supportedState() {
    return ServiceOrderStateType.REJECTED;
  }
