...
import at.compax.reference.subsystem.tmf641.component.model.ServiceOrderStateChangeEventPayload;
import lombok.RequiredArgsConstructor;

@Component
@RequiredArgsConstructor
public class EventStateChangeEventTranslator implements IncomingTranslator<Event> {

  private final ObjectMapper objectMapper;
  private final StateChangeEventTranslator stateChangeEventTranslator;

  @Override
  public ValuesBuilder translate(ValuesBuilder builder, Event model) {
    ServiceOrderStateChangeEventPayload serviceOrderCreateEventPayload = objectMapper.convertValue(model.getEvent(), ServiceOrderStateChangeEventPayload.class);
    ...
    stateChangeEventTranslator.translate(builder, serviceOrderCreateEventPayload.getServiceOrder());
