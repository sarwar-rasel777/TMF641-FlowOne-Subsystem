...
import at.compax.reference.subsystem.tmf641.component.model.ServiceOrderStateChangeEvent;
...
@Log4j2
@SubsystemPayload(translator = EventStateChangeEventTranslator.class)
public abstract class ServiceOrderStateChangeEventService implements SubsystemService, ReceivingService<Event>, ServiceOrderStateTypeValidator {

  public static final String STATE_CHANGE_EVENT_TYPE = "ServiceOrderStateChangeEvent";

  private final EventStateChangeEventTranslator eventTranslator;
  ...
  protected ServiceOrderStateChangeEventService(EventStateChangeEventTranslator eventTranslator, ValuesBuilderFactory valuesBuilderFactory, ObjectSerializer objectSerializer, ObjectMapper objectMapper, ObjectValidator objectValidator,
  ...
  public boolean support(Event event) {
    ...
    StateChangeEvent serviceOrder;
    try {
      ServiceOrderStateChangeEvent serviceOrderCreateEvent = objectMapper.convertValue(event, ServiceOrderStateChangeEvent.class);
    ...
    List<ServiceOrderItemStateChangeEvent> serviceOrderItems = serviceOrder.getServiceOrderItem();
