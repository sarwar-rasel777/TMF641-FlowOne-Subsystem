...
public class ServiceOrderItemTranslator implements Translator<ServiceOrderItem> {

  private final ServiceTranslator serviceTranslator;

  @Override
  public ServiceOrderItem translate(ValuesConsumer consumer) {
  ...
  @Override
  public ValuesBuilder translate(ValuesBuilder builder, ServiceOrderItem model) {
    builder.addMapValue() //
