...
@Service("serviceOrderFailed")
public class ServiceOrderFailed extends ServiceOrderStateChangeEventService {

  @Autowired
  public ServiceOrderFailed(EventStateChangeEventTranslator eventTranslator, ValuesBuilderFactory valuesBuilderFactory, ObjectSerializer objectSerializer, ObjectMapper objectMapper, ObjectValidator objectValidator, @Lazy ReceivingSender receivingSender) {
  ...
  public ServiceOrderStateType supportedState() {
    return ServiceOrderStateType.FAILED;
  }
